@echo off
echo 🚀 Starting Job Portal System with MongoDB Integration...
echo.
...
start "Job Portal Backend (MongoDB)" cmd /k "cd /d "%~dp0backend" && node server-mongodb.js"
...
echo.
echo 🎉 Job Portal with MongoDB is starting up!
echo.
echo 📋 System URLs:
...
echo.
echo ✅ Job Portal with MongoDB Started Successfully!
echo.
echo 💡 Tips:
